...
export declare namespace DatabaseManager {
    ...
    function GenerateDOT(addresses: Map<string, Address>[], bundles: Map<string, Bundle>[], edges: Map<string, Transaction>, outputColors: (string | undefined)[], renderColors: (string | undefined)[]): string;
